...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "_footer_v_version_nav_items" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"link_type" "enum__footer_v_version_nav_items_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar NOT NULL,
  	"_uuid" varchar
  ...
  ALTER TABLE "media" ADD CONSTRAINT "media__h_media_id_media_id_fk" FOREIGN KEY ("_h_media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_media_v" ADD CONSTRAINT "_media_v_version__h_media_id_media_id_fk" FOREIGN KEY ("version__h_media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "media__h_media_idx" ON "media" USING btree ("_h_media_id");
  ...
  CREATE INDEX "_media_v_version_version__h_media_idx" ON "_media_v" USING btree ("version__h_media_id");
